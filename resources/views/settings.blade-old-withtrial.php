                    ...
                    <form method="post" action="{{ url('settings') }}/{{ $shop }}">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer">
								<input type="hidden" name="settings[apiKey]" id="apiKey" value="{{ (isset($settings->apiKey)) ? $settings->apiKey : '' }}" >
								<input type="hidden" name="settings[userName]" id="apiKeyUserName" value="{{ (isset($settings->userName)) ? $settings->userName : '' }}" >
            ...
            $(function () {
				...
				$('#loginaccount').on('click',function(){
					...
					if(username==''){
						...
						$.ajax({
							url:"https://api.vbout.com/1/app/login", 
							data:postdata,
							type:"POST",

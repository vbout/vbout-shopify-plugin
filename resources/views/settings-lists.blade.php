<div class="row">
    ...
    <div class="col-md-6">
        <div class="row">
            ...
            <div class="col-md-4">
                <a href="https://app.vbout.com/Lists" target="_blank">Create List</a>
            </div>
        </div>
    </div>
</div>
...
<div class="row custom-fields-wrapper">
    @if (count($shopifyFieldsIncomplete) > 0)
        @php ($i = 0)
        @foreach ($shopifyFieldsIncomplete as $field)
            <div class="custom-fields-content">
                <div class="col-md-6">
                    {{ ucwords(str_replace('_', ' ', $field)) }}
                </div>
...
<div class="row">
    <div class="col-md-6">
        <label><span class="glyphicon glyphicon-play" aria-hidden="true"></span> Shopify Completed Purchases</label>
    </div>
    <div class="col-md-6">
        <div class="row">
            <div class="col-md-8">
...
<div class="row custom-fields-wrapper">
    @if (count($shopifyFieldsPurchase) > 0)
        @php ($i = 0)
        @foreach ($shopifyFieldsPurchase as $field)
            <div class="custom-fields-content">
                <div class="col-md-6">
                    {{ ucwords(str_replace('_', ' ', $field)) }}
                </div>
